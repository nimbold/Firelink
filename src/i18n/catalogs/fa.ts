const fa = {
  ...
  scheduler: {
    ...
    windowsActionsDescription: 'خواب، راه‌اندازی مجدد و خاموش کردن از دسترسی‌های سیستم Windows استفاده می‌کنند. Firelink هنگام اجرا هر اقدام رد شده‌ای را گزارش می‌دهد؛ هیچ مجوز دائمی از قبل درخواست نمی‌شود.',
    linuxActionsDescription: 'خواب، راه‌اندازی مجدد و خاموش کردن از دسکتاپ و سیاست‌های سیستم Linux استفاده می‌کنند. Firelink هنگام اجرا هر اقدام رد شده‌ای را گزارش می‌دهد؛ هیچ مجوز دائمی از قبل درخواست نمی‌شود.',
  ...
  properties: {
    ...
    savedTooltip: 'برای این دانلود ذخیره شد؛ تغییرات تنظیمات روی دانلودهای جدید اعمال می‌شود.',
    ...
    savedPerDownload: 'برای هر دانلود ذخیره شد. پیش‌فرض تنظیمات روی دانلودهای جدید اعمال می‌شود.',
    limit: 'محدودیت',
  ...
  settings: {
    ...
    common: {
      ...
      pythonRuntimeFound: 'محیط اجرای Python پیدا شد',
