const fa = {
  ...
  settings: {
    ...
    engine: {
      ...
      cookieFileDescription: 'اختیاری؛ خروجی کوکی با قالب Netscape. این فایل بر منبع مرورگر اولویت دارد؛ yt-dlp فقط هنگام درخواست‌های رسانه آن را می‌خواند و Firelink محتوای آن را ذخیره نمی‌کند.',
