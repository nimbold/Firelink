const common = {
  ...
  addDownloads: {
    ...
    destinationCheckFailed: 'Could not check the destination. Try again or choose a different location.',
    ...
    cookieFileInvalid: 'The selected cookie file is unavailable or is not a regular file. Choose it again in Settings → Media Extractors.',
    youtubeBotBlocked: 'YouTube blocked this request as automated. Select a signed-in browser source or Netscape cookie file, then refresh metadata.',
    youtubeAuthenticationRequired: 'YouTube requires authentication for this media. Sign in to the browser account, export Netscape cookies, or select the correct browser source, then refresh metadata.',
    youtubePoTokenRequired: 'YouTube requires a valid PO token for this client. Try a signed-in browser source or Netscape cookie file, then refresh metadata.',
    ...
    mediaModeAuto: 'Auto-detect',
    treatAsMedia: 'Treat as media',
    treatAsFile: 'Treat as file',
    mediaModeUnavailable: 'Media mode requires an HTTP(S) URL without embedded credentials.',
  ...
  settings: {
    ...
    lookAndFeel: {
      ...
      startAtLogin: 'Start automatically at system login',
      startAtLoginDescription: 'Starts Firelink in the background when you sign in. The window stays hidden until you open it from the tray.',
      startAtLoginUnsupported: 'Automatic startup is unavailable on this platform.',
      startAtLoginRequiresApproval: 'Approval is required in the system login-item settings.',
      openLoginItemsSettings: 'Open login-item settings',
      startAtLoginCheckFailed: 'Could not check automatic startup: {{detail}}',
      startAtLoginUpdateFailed: 'Could not update automatic startup: {{detail}}',
      startAtLoginSettingsFailed: 'Could not open login-item settings: {{detail}}',
      trayRequiredForStartAtLogin: 'The tray icon stays available while automatic startup is enabled.',
    },
    network: {
      proxy: 'Proxy',
      mode: 'Mode',
    ...
    coreDownloader: 'Core Downloader (aria2)',
      ...
      cookieDescription: 'Public media usually works without cookies. If a site requires you to sign in, choose the browser where you are signed in; yt-dlp reads its cookies directly, so no manual export is needed. Firelink does not save browser cookie contents.',
      cookieFile: 'Netscape cookie file:',
      cookieFileDescription: 'Usually leave this empty. With a browser selected, Firelink tries this Netscape-format file only if it cannot read that browser’s cookies. With no browser selected, the file is used as the cookie source. Firelink does not save its contents.',
      chooseCookieFile: 'Choose cookie file',
      clearCookieFile: 'Clear cookie file',
      none: 'None',
    },
    integrations: {
