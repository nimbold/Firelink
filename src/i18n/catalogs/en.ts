const common = {
  ...
  settings: {
    ...
    coreDownloader: 'Core Downloader (aria2)',
      ...
      cookieFileDescription: 'Optional Netscape-format cookie export. It takes precedence over the browser source; yt-dlp reads it only during media requests and Firelink does not store its contents.',
