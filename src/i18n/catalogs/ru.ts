const ru = {
  ...
  settings: {
    ...
    engine: {
      ...
      cookieFileDescription: 'Необязательно; экспорт cookie в формате Netscape. Он имеет приоритет над источником браузера; yt-dlp читает его только во время запросов медиа, а Firelink не сохраняет его содержимое.',
