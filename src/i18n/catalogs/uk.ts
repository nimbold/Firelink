const uk = {
  ...
  addDownloads: {
    ...
    destinationCheckFailed: 'Не вдалося перевірити місце призначення. Спробуйте ще раз або виберіть інше.',
    ...
    cookieFileInvalid: 'Вибраний файл cookie недоступний або не є звичайним файлом. Виберіть його знову в налаштуваннях → Екстрактори медіа.',
    youtubeBotBlocked: 'YouTube заблокував запит як автоматичний. Виберіть браузерне джерело з виконаним входом або файл cookie Netscape й оновіть метадані.',
    youtubeAuthenticationRequired: 'Для цього медіа YouTube потребує автентифікації. Увійдіть у браузер, експортуйте cookie Netscape або виберіть правильне джерело браузера й оновіть метадані.',
    youtubePoTokenRequired: 'Для цього клієнта YouTube потребує дійсний PO-токен. Спробуйте браузерне джерело з виконаним входом або файл cookie Netscape й оновіть метадані.',
    ...
    invalid: 'Недійсно',
    ready: 'Готово',
    mediaHandling: 'Обробка медіа',
    mediaModeAuto: 'Визначати автоматично',
    treatAsMedia: 'Вважати медіа',
    treatAsFile: 'Вважати файлом',
    mediaModeUnavailable: 'Для медіарежиму потрібна URL-адреса HTTP(S) без вбудованих облікових даних.',
  ...
  settings: {
    ...
    lookAndFeel: {
      ...
      startAtLogin: 'Автоматично запускати під час входу в систему',
      startAtLoginDescription: 'Запускає Firelink у фоновому режимі під час входу в систему. Вікно залишається прихованим, доки ви не відкриєте його з трею.',
      startAtLoginUnsupported: 'Автоматичний запуск недоступний на цій платформі.',
      startAtLoginRequiresApproval: 'Потрібне підтвердження в налаштуваннях елементів запуску системи.',
      openLoginItemsSettings: 'Відкрити налаштування елементів запуску',
      startAtLoginCheckFailed: 'Не вдалося перевірити автоматичний запуск: {{detail}}',
      startAtLoginUpdateFailed: 'Не вдалося оновити автоматичний запуск: {{detail}}',
      startAtLoginSettingsFailed: 'Не вдалося відкрити налаштування елементів запуску: {{detail}}',
      trayRequiredForStartAtLogin: 'Піктограма в треї залишається доступною, доки автоматичний запуск увімкнено.',
    },
    network: {
      proxy: 'Проксі',
      mode: 'Режим',
    ...
    engine: {
      ...
      cookieDescription: 'Для загальнодоступних медіа зазвичай не потрібні файли cookie. Якщо сайт вимагає входу, виберіть браузер, у якому ви ввійшли; yt-dlp читає файли cookie безпосередньо з нього, тому експортувати їх вручну не потрібно. Firelink не зберігає вміст файлів cookie браузера.',
      cookieFile: 'Файл cookie Netscape:',
      cookieFileDescription: 'Зазвичай залишайте це поле порожнім. Якщо вибрано браузер, Firelink використовує файл Netscape лише тоді, коли не вдається прочитати файли cookie з браузера. Якщо браузер не вибрано, файл стає джерелом файлів cookie. Firelink не зберігає його вміст.',
      chooseCookieFile: 'Вибрати файл cookie',
      clearCookieFile: 'Очистити файл cookie',
      none: 'Немає',
    },
    integrations: {
