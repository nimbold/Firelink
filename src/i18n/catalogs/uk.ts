const uk = {
  ...
  dialogs: {
    ...
    removeDownload: {
      ...
      confirmationSingle: 'Ви впевнені, що хочете видалити цей елемент зі списку? Ви також можете видалити сам файл з вашого жорсткого диска.',
      confirmationMultiple: 'Ви впевнені, що хочете видалити ці {{count}} елементів зі списку? Ви також можете видалити самі файли з вашого жорсткого диска.',
  ...
  speedLimiter: {
    ...
    customPresetIn: 'Свій пресет в {{unit}}',
  ...
  sidebar: {
    deleteQueueConfirm: 'Видалити чергу "{{name}}"? Її незавершені завантаження перемістяться до Головної черги (Main Queue).',
  ...
  downloadTable: {
    ...
    revealFileFailed: 'Не вдалося показати завантаження в Finder / Провіднику',
  ...
  addDownloads: {
    ...
    playlistSummary: 'Плейлист “{{title}}”: {{loaded}}{{total}} елементів завантажено{{truncated}}{{skipped}}',
    ...
    correctInvalidMany: 'Виправте або видаліть {{count}} недійсні URL-адреси перед продовженням.',
    ...
    removeUnsafeMany: 'Видаліть {{count}} небезпечні URL-адреси перед продовженням.',
