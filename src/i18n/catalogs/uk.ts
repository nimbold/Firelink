const uk = {
  ...
  settings: {
    ...
    engine: {
      ...
      cookieFileDescription: 'Необов’язково; експорт cookie у форматі Netscape. Він має пріоритет над джерелом браузера; yt-dlp читає його лише під час медіазапитів, а Firelink не зберігає його вміст.',
