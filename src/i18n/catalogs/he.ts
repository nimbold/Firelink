const he = {
  ...
  addDownloads: {
    ...
    destinationCheckFailed: 'לא ניתן לבדוק את היעד. נסה שוב או בחר יעד אחר.',
    ...
    cookieFileInvalid: 'קובץ העוגיות שנבחר אינו זמין או אינו קובץ רגיל. בחר אותו שוב בהגדרות → מחלצי מדיה.',
    youtubeBotBlocked: 'YouTube חסם את הבקשה כאוטומטית. בחר מקור דפדפן מחובר או קובץ עוגיות Netscape ורענן את המטא־נתונים.',
    youtubeAuthenticationRequired: 'YouTube דורש אימות עבור המדיה הזו. התחבר לחשבון בדפדפן, ייצא עוגיות Netscape או בחר את מקור הדפדפן הנכון ורענן את המטא־נתונים.',
    youtubePoTokenRequired: 'YouTube דורש PO token תקף עבור הלקוח הזה. נסה מקור דפדפן מחובר או קובץ עוגיות Netscape ורענן את המטא־נתונים.',
    ...
    invalid: 'לא תקין',
    ready: 'מוכן',
    mediaHandling: 'טיפול במדיה',
    mediaModeAuto: 'זיהוי אוטומטי',
    treatAsMedia: 'התייחס כמדיה',
    treatAsFile: 'התייחס כקובץ',
    mediaModeUnavailable: 'מצב מדיה דורש כתובת HTTP(S) ללא פרטי התחברות מוטמעים.',
  ...
  settings: {
    ...
    lookAndFeel: {
      ...
      startAtLogin: 'הפעל אוטומטית בעת הכניסה למערכת',
      startAtLoginDescription: 'מפעיל את Firelink ברקע בעת הכניסה. החלון נשאר מוסתר עד שפותחים אותו מהמגש.',
      startAtLoginUnsupported: 'הפעלה אוטומטית אינה זמינה בפלטפורמה הזו.',
      startAtLoginRequiresApproval: 'נדרש אישור בהגדרות פריטי הכניסה למערכת.',
      openLoginItemsSettings: 'פתח את הגדרות פריטי הכניסה',
      startAtLoginCheckFailed: 'לא ניתן לבדוק את ההפעלה האוטומטית: {{detail}}',
      startAtLoginUpdateFailed: 'לא ניתן לעדכן את ההפעלה האוטומטית: {{detail}}',
      startAtLoginSettingsFailed: 'לא ניתן לפתוח את הגדרות פריטי הכניסה: {{detail}}',
      trayRequiredForStartAtLogin: 'סמל המגש נשאר זמין כל עוד ההפעלה האוטומטית פעילה.',
    },
    network: {
      proxy: 'פרוקסי',
      mode: 'מצב',
    ...
    engine: {
      ...
      cookieDescription: 'תוכן מדיה ציבורי בדרך כלל פועל ללא עוגיות. אם אתר דורש התחברות, בחרו בדפדפן שבו אתם מחוברים; yt-dlp קורא את העוגיות ישירות ממנו, ואין צורך בייצוא ידני. Firelink אינו שומר את תוכן עוגיות הדפדפן.',
      cookieFile: 'קובץ עוגיות Netscape:',
      cookieFileDescription: 'בדרך כלל השאירו את השדה ריק. כשנבחר דפדפן, Firelink משתמש בקובץ Netscape רק אם אינו מצליח לקרוא את העוגיות מהדפדפן. ללא דפדפן נבחר, הקובץ משמש כמקור העוגיות. Firelink אינו שומר את תוכנו.',
      chooseCookieFile: 'בחירת קובץ עוגיות',
      clearCookieFile: 'ניקוי קובץ עוגיות',
      none: 'ללא',
    },
    integrations: {
