const zhCN = {
  ...
  dialogs: {
    ...
    removeDownload: {
      title: '移除下载',
      confirmationSingle: '您确定要从列表中移除此项目吗？您也可以选择从硬盘中删除底层文件。',
      confirmationMultiple: '您确定要从列表中移除这 {{count}} 个项目吗？您也可以选择从硬盘中删除底层文件。',
  ...
  downloads: {
    ...
    size: {
      ...
      downloadedOfApproximate: '已下载 {{downloaded}} / 约 {{total}} {{unit}}',
    },
    status: {
      ready: '就绪',
      staged: '在队列中',
  ...
  speedLimiter: {
    ...
    description: '适用于新的和活动的 aria2 传输以及新的 yt-dlp 媒体下载。每个下载的显式限制仍然附加到这些传输上。',
    quickPresets: '快速预设',
    removePreset: '移除 {{value}} {{unit}} 预设',
    customPresetIn: '自定义预设 (单位：{{unit}})',
    addQuickPreset: '添加快速预设',
    globalLimitSaved: '全局限制已保存为 {{value}} {{unit}}',
    globalLimitDisabled: '全局速度限制已禁用',
    saveFailed: '无法保存全局速度限制：{{detail}}',
    presetAlreadyExists: '{{value}} {{unit}} 已在快速预设中',
    presetAdded: '已添加 {{value}} {{unit}} 快速预设',
    presetRemoved: '已移除 {{value}} {{unit}} 快速预设',
  },
  logs: {
    title: '日志',
    entries: '({{count}} 条)',
    ...
    diagnosticsDescription: '诊断收集需要主动开启，受范围限制并且在本地进行。常见的密钥、URL 查询参数和主目录路径在显示和导出时都会被隐藏。不会自动上传任何数据。',
  ...
  scheduler: {
    ...
    startTime: '开始时间',
    stopTime: '停止时间',
    timingDescription: '如果在开始时间 Firelink 处于休眠状态，它将在当天晚些时候恢复时启动所选队列，除非停止时间已过。',
    runEveryDay: '每天运行',
    queuesToSchedule: '要调度的队列',
    defaultQueue: '默认队列',
  ...
  properties: {
    ...
    saved: ' (已保存)',
    defaultValue: ' (默认)',
    savedTooltip: '已为此下载保存；设置的更改将应用于新的下载。',
  ...
  sidebar: {
    ...
    startQueueFailed: '无法开始队列：{{detail}}',
  ...
  downloadTable: {
    ...
    copyFilePath: '复制文件路径',
    properties: '属性',
    backendRejectedStart: '后端拒绝了开始/继续请求。',
  ...
  addDownloads: {
    ...
    speedLimitPerFileAria: '每个文件的速度限制 (Aria)',
    authorization: '授权',
